 ...
 *  @author Kevin Wayne
 */
public class PrimMST implements IGraph {
	...
	public Bag<Edge> adjEdges(int vertex) {
		...
		for (int i = 0; i < edgeTo.length; i++) {
			Edge currEdge = edgeTo[i];
			if (currEdge != null && (currEdge.either() == vertex || currEdge.other(currEdge.either()) == vertex)) {
				edges.add(currEdge);
			}
		}
		return edges;
